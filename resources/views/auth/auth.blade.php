...
<div class="auth-container">
    ...
    <div class="auth-content">
        ...
        <div class="auth-card">
            <div class="auth-tabs">
                <button class="auth-tab {{ request()->routeIs('login') ? 'active' : '' }}" onclick="window.location.href='{{ route('login') }}'">Masuk</button>
                <button class="auth-tab {{ request()->routeIs('register') ? 'active' : '' }}" onclick="window.location.href='{{ route('register') }}'">Daftar</button>
            </div>
            ...
            @else
                ...
                <form id="register-form" class="auth-form" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-input-container">
                            <svg class="form-input-icon" viewBox="0 0 24 24"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>
                            <input type="text" name="name" class="form-input" placeholder="Masukkan Username Anda" value="{{ old('name') }}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-input-container">
                            <svg class="form-input-icon" viewBox="0 0 24 24"><path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z"/></svg>
                            <input type="password" name="password_confirmation" class="form-input" placeholder="Masukkan Ulang Password Anda" required>
                        </div>
                    </div>
